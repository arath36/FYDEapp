...
class BLECentralViewController : UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate, UITableViewDelegate, UITableViewDataSource{
    ...
    //Data
    // Central manager is CBCentralManager Variable. Manages the connections on the app in the CoreBluetooth Framework
    
    var centralManager : CBCentralManager!
    
    //NS is an Objective C framework that includes classes that C does not
    var RSSIs = [NSNumber]()
    var data = NSMutableData()
    var writeData: String = ""
    // CB peripheral is a variable to handle peripherals   IS an array of peripherals
    var peripherals: [CBPeripheral] = []
    // Dictionary matching UUIDs to Data
    var characteristicValue = [CBUUID: NSData]()
    var timer = Timer()
    // Dictionary matching Strings to BLE characteristics
    ...
    // This is what happens when the user pulls down the table view and "refreshes it"
    
    @IBAction func refreshAction(_ sender: AnyObject) {
        // Calls function in this code
        disconnectFromDevice()
        // Emptys peripheral array, RSSI
        self.peripherals = []
        self.RSSIs = []
       ...
       // Below are the actions that are taken when this specific ViewController Appears, Loads, and Dissapears
    
    override func viewDidLoad() {
        super.viewDidLoad()
        // Don't really understand delegates but all seem to be set to self, don't know why, but this neccessary in getting them up and running
        // "self" is used when we want to access a variable outside of the 'ViewDidLoad'
        ...
        // makes backButton a variable, then sets the navigation bar button to the backButton
    ...
    override func viewWillDisappear(_ animated: Bool) {
        // Stops scan when the view controller will dissappear. Like when the back button is pressed
    ...
    // These are user functions that they gave us and then they call in the swift core functions (ViewDidLoad/DidAppear/WillDissapear, central manager stuff, peripheral stuff)
    func startScan() {
        peripherals = []
        print("Now Scanning...")
    ...
    /*
     Called when the central manager discovers a peripheral while scanning. Also, once peripheral is connected, cancel scanning. This is called automatically****
     */
    func centralManager(_ central: CBCentralManager, didDiscover peripheral: CBPeripheral,advertisementData: [String : Any], rssi RSSI: NSNumber) {
        
        blePeripheral = peripheral
        // appends the peripheral to the arrays we have
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        // Set the number of cells in the table view to the number of objects in ther 'peripherals' array
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        // connects to the device if the cell is selected
